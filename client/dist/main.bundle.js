...
module.exports = "<nav class=\"navbar navbar-toggleable-md navbar-inverse  bg-inverse bg-darkblue fixed-top\">\n  <a class=\"navbar-brand\" href=\"#\">Awear Solutions</a>\n  <div class=\"container\">\n    <span class=\"navbar-brand\"> select date and time</span>\n\n    <input [ngModel]=\"momentValue | amDateFormat: 'DD-MM-YYYY HH:mm'\" [dateTimePicker]=\"momentValue\" [theme]=\"'#292b2c'\" (dateTimePickerChange)=\"setMoment($event)\"\n      readonly />\n    <input [ngModel]=\"momentValue | amAdd: 2 : 'hours' | amDateFormat: 'DD-MM-YYYY HH:mm'\" disabled />\n  </div>\n</nav>\n\n<div class=\"container\">\n  <div class=\"starter-template\">\n    <h2>{{ title }}</h2>\n    <p class=\"lead\">number of tags fetch : {{tagCount}} number of geos fetch : {{geoCount}} </p>\n  </div>\n</div>\n\n<!-- this creates a google map on the page with the given lat/lng from -->\n<!-- the component as the initial center of the map: -->\n\n<agm-map [latitude]=\"lat\" [longitude]=\"lng\">\n  <!--<agm-marker [latitude]=\"lat\" [longitude]=\"lng\" [label]=\"'Z'\" (markerClick)=\"clickedMarker('Z', i)\" ></agm-marker>-->\n  <agm-marker *ngFor=\"let mark of reports; let i = index\" (markerClick)=\"clickedMarker(mark.label, i)\" [latitude]=\"mark.location.coordinates[1]\"\n    [longitude]=\"mark.location.coordinates[0]\" [markerDraggable]=\"true\" [label]=\"mark.label\">\n    <agm-info-window>\n      <strong>{{mark | json}}</strong>\n    </agm-info-window>\n  </agm-marker>\n</agm-map>\n\n<footer class=\"footer\">\n  <div class=\"container\">\n    <span class=\"text-muted\">\n      Made with <i class=\"fa fa-heart\" aria-hidden=\"true\" style=\"color: red;\"></i>️ by Tomer\n</span>\n</div>\n</footer>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reports_service__ = __webpack_require__("./src/app/reports.service.ts");
...
var AppComponent = (function () {
    function AppComponent(reportService) {
        ...
        this.title = 'Awear Solutions';
        this.lat = 43.8111842796614470;
        this.lng = -90.8245581575583860;
        this.reports = [];
        this.geoCount = 0;
        this.tagCount = 0;
    }
    AppComponent.prototype.ngOnInit = function () {
        this.momentValue = __WEBPACK_IMPORTED_MODULE_2_moment__().subtract(2, 'h');
    };
    AppComponent.prototype.setMoment = function (momentVal) {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ng_pick_datetime__ = __webpack_require__("./node_modules/ng-pick-datetime/picker.module.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__reports_service__ = __webpack_require__("./src/app/reports.service.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_8__reports_service__["a" /* ReportsService */]],
